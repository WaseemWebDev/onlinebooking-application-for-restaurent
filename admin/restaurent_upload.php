    ...
    if (isset($_POST["submit"])) {
        ...
        if ($fileError == 0) {
            ...
            if (move_uploaded_file($filePath, $destFile)) {
                $sql = "insert into restaurents(`name`,`location`,`image`,`price`,`description`,`status`) values('$name','$location','$destFile','$price','$description','no review')";
                ...
                if ($query) {
                    ...
                    <script>
                        ...
                        location.href = "restaurent_upload.php";
                    </script>
                    <?php
                }
            }
...
<?php include './dashboard.php'; ?>
                <div class="col-md-6 ml-5" >
                    <br/><br/><br/>
                    <center><h2>Upload Restaurent Details Here</h2></center>
                    <br/>
